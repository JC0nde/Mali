...
@section('content')
  <section class="hero">
    <div class="container">
      <div class="contact">
        ...
        <div class="content">
          <h1>Contact</h1>
          <p>Ce n'est jamais trop tôt, demandez-moi n'importe quoi.</p>
        </div>

        <div class="content">
          @if (Session::has('success'))
            <div class="alert btn-success" role="alert">
              <strong>Envoyé:</strong> {{ Session::get('success') }}
            </div>
          @endif
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ url('contact') }}">
            ...
            <div class="form-group{{ $errors->has('message') ? ' has-error' : '' }}">
              ...
              <div class="col-md-6">
                <textarea id="message" type="text" class="form-control" name="message" value="message" required autofocus></textarea>
        ...
        <!-- <div class="callout rule">
             <span class="text">Donnes-m'en plus!</span>
             </div>

             <div class="callouts">
             <a class="third callout pop" href="https://twitter.com/JC0nde" target="_blank">
             <div class="callout-head">
             <div class="callout-title">Twitter</div>
             ...
             <a class="third callout pop teal" href="https://ch.linkedin.com/in/jonathanconde" target="_blank">
             <div class="callout-head">
             <div class="callout-title">LinkedIn</div>
             ...
             </a>                <a class="third callout pop" href="https://github.com/JC0nde" target="_blank">
             <div class="callout-head">
             <div class="callout-title">GitHub</div>
  ...
  <div id="map">
    <section class="panel">
      <p class="intro">
        E-mail:
        <a class="first" href="mailto:mail@jonathanconde.com">
          mail@jonathanconde.com
        </a>
        Téléphone:
        <a href="tel:+41765926194">
          +41 (0)76 592 61 94
        </a>
        <br>
        <br>
      ...
      <p class="intro">
        <i class="marker"></i>
        Avenue du Vieux-Moulin 14<br>1018 Lausanne, Suisse
      </p>
      <p class="intro">
        <a class="btn" href="https://maps.google.com/maps?cid=10652211389274937092" title="Trying to find us? Click here to view a map of our location.">
